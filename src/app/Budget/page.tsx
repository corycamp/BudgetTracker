...
export default function BudgetsPage() {
  ...
  return (
    ...
    {/* <div className="h-screen bg-[#0D0F14] text-white font-sans p-8"> */}
      ...
      {/* Current Budgets */}
      <section>
        <h2 className="text-lg font-semibold mb-4 text-white">Current Budgets</h2>
        <BudgetTable budgets={budgets}/>
      </section>

      {/* Budget Alerts */}
      <section className="mt-10">
        <h2 className="text-lg font-semibold mb-4 text-white">Budget Alerts</h2>
        <div className="bg-[#1C1E24] rounded-2xl p-6 flex justify-between items-center">
          <div>
            <h3 className="font-medium text-white mb-1">Enable Budget Alerts</h3>
